...
class SiteControllerTest < Test::Unit::TestCase
  ...
  def test_index
    get :index
    title = assigns(:title)
    assert_equal "Welcome to the Online Taxi Booking System!", title
  ...
  def test_about
    get :about
    title = assigns(:title)
    assert_equal "About the Online Taxi Booking System", title
    assert_response :success
  ...
  def test_help
    get :help
    title = assigns(:title)
    assert_equal "Online Taxi Booking Help", title
    assert_response :success
